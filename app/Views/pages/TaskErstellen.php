...
<!--                                </ul>-->
<!--                            </div>-->
                            <input type="number" class="form-control rounded-end" id="" placeholder="taskartenid" name="taskartenid">
                        </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="number" class="form-control rounded-end" id="Spalte" placeholder="spaltid" name="spaltenid">
<!--                        // databank access-->
